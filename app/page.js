  ...
  return (
    <>
      <div className="flex space-x-6">
        <div className="bg-blue-100 rounded-lg p-5 w-80">
            <div className="font-bold text-white mb-5 bg-blue-500 w-full rounded-lg">ข้อมูลสุขภาพของฉันล่าสุด</div>
      ...
      <div>
      <div className="grid gap-4 w-full h-9 p-2 bg-green-600 rounded-lg font-bold text-white mb-4 text-left">แผนการดูแลสุขภาพรายวัน</div>
      </div>
